...
class drone_control():
    ...
    def __init__(self):
        ...
        self.manouver_time_threshold = 5
    ...
    def avoidance_manouver(self,x,y,psi):
        ...
        while manouver_time<self.manouver_time_threshold:
            end_time = time.time()
            ...
            if self.control_mode == True:
                ...
                while self.control_mode == False:
                     ...
                     if total_loop_time >self.loop_time_threshold:
                        ...
                        self.drone.set_mode("Guided") # we make the drone able to fly again.
                        return  #if we break the function here is because no person is nearby after some time
                    #if loop is broken self.control_mode == True, a person was detected again
